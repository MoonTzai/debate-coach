...
**Layer 2: Scope of Discussion / Perspective Entry** -- within Layer 1, focus on a proper subset, constructing "our side more important comparative platform." **This is not drawing a circle and only fighting inside it — the opponent's weights (facts and evidence) are all still on the table; you have denied none of them.** You are telling the judge by what standard to compare both sides. Does not change the extension itself, only shifts subjective weight -- "Shift the balance, not the facts." **Essence: elevate the importance of the focused proper subset, while reducing the importance of everything else.** This mechanism shares the same underlying logic with the criterion B0 (A3) — both shift the distribution of importance through selective focus. The difference lies in the level of focus: Scope of Discussion focuses on a proper subset of the Inherent Definitional Domain ("which people / what context" — e.g., "focusing on 35-year-olds with a 50-50 chance of rooting down in first-tier cities"), while criterion B0 focuses on the evaluative criterion ("by what balance to weigh" — e.g., "whether the family can bear the risk"). In most cases these are separate operations (first focus the subset, then establish the criterion). In the extreme case they converge — when Scope of Discussion = Standard itself (§4.1), but this is all-definition-warfare and generally not recommended. Two directions: top-down (first determine the scope, then find the Standard) or bottom-up (first find a strong Standard, then reverse-engineer the scope). Academic references: Entman Framing Theory -- to frame = to select + make salient; Burke Terministic Screen theory -- legitimate entry = selective focusing within the common-sense Terministic Screen.
...
**Type 1 vs. Type 2 — The Operational Distinction: Concede or Deny**: Type 1 Mainline — both sides' architectures and argumentation lines converge into a single Mainline through Structural Clash and continue advancing; the prevailing side can accommodate the opponent's reasonable points; there is clear Structural Clash and a decisive logic. Type 2 Mainline — both sides' architectures and argumentation lines do not undergo Structural Clash, remaining as two parallel Mainlines each advancing and clashing on their own tracks; lacking the decisive inference or anchor point that Structural Clash produces. Both sides cannot accommodate the opponent's reasonable points; the two architectures have never collided and reconstructed. Test: ask yourself "Can my structure concede the opponent's reasonable points?" → If it can accommodate, Type 1 has space. If it completely cannot, at most Type 2.
...
**Debate Can Give Reasons** (Lecture 6.3): "Debate is not something where you must disprove the opponent to hold. In debate, the opponent CAN hold, and our side STILL holds." Through perspective entry (introducing an additional reason B-prime), the opponent, though holding, decreases in importance, while our side still holds and increases in importance. This is not a question of logic / proof -- it is a question of "persuasion": if our side argumentation requires the opponent to be wrong -> it will seem "not quite reasonable enough"; if our side argumentation can accommodate the opponent being right -> it will seem "quite reasonable indeed."
...
**Upward Critique**: Upward (pursue upward along the ladder, asking "Why behind this?") + Critique (search in the opposite direction of popular perception). Two principles: "Affirm what everyone negates; negate what everyone affirms"; "For moral claims, find the real-world angle; for real-world claims, find the moral angle." Through the Perspective by Incongruity (§1.5) four-quadrant operation, trace from four directions **what forces drive people to accept this value** — not what consequences result from accepting it. The value is the driven outcome. Four directions (Positive + Value / Positive + Reality / Negative + Value / Negative + Reality) exhaustively explored. Lecture 7 further distinguishes External Persuasion (surface professionalism / sense of balance — the shallow effect of "feeling the other side sounds right") and Internal Persuasion (focusing on the other party core needs — the deep-level persuasion that "cannot be refused"). Tracing driving forces through the four quadrants (cause-direction) is essentially the operational method for excavating Internal Persuasion: asking "why do people believe this" rather than "what benefits come from believing this." **The Value Ladder not only has non-unique paths and quantities of answers, but also non-unique directions** (Lecture 7 Slides 27-28 SmartArt) -- behind positive reasons one can find negative motivations (e.g., "filial piety is an insurance mechanism securing benefits in old age"); behind dark behaviors one can find noble emotions (e.g., "environmentalism that cannot achieve economic benefits cannot possibly be implemented"). Self-check: "Do not treat the audience as fools" -- passing clash is the baseline for having an idea; audience acceptance is the basis for settling on a point.
...
**Persuasion-Proof-Third-Party Three-Dimensional Coordinate System** -- Persuasion axis: Rational (common-sense expectations / personal experience) vs Emotional (situational experience / new perspectives / new information); Proof axis: Falsification (self-consistency / clash) vs Verification (self-proof / advancement); Third-Party axis: Operationality / Situational Sense (action completion, rule completion) vs Profundity / Meaning Sense (academic quality, discussion value, inspiration). Each axis is a spectrum, not a simple binary (Slide 63/69 SmartArt). Six Judge Archetypes (one pair per axis, mutually contradictory/restraining; each judge is a mixture of all six dimensions, not a single pure type):
- Persuasion axis — Guardian (values objectivity, common-sense expectations, safety & satisfaction; imposes a heavier burden of proof on counter-intuitive claims) ↔ Seeker (values new information, exceeding expectations, challenging common sense; receptive to emotional / new perspectives / situational experience, stimulation & enlightenment)
- Proof axis — Critic (values active clash and dismantling the opponent; extreme form = any point the opponent does not attack stands, no self-proof needed) ↔ Judge (like a judge evaluating evidence; extreme form = you must fully prove yourself, merely stating it is not enough)
...
**Four Judge Observation Forms** (Zhang Zheyao, 2017 International Chinese Debate Invitational Judging Standards): Point Judge / Counting Judge (records each argument's argumentation and clash, summarizes -- most "objective"), Flow Judge (looking only at overall argumentation flow / deformation), Value Judge (selects the most valuable points in the clash to determine victory or defeat -- subjective), Social Judge (purely by personal intervention -- closest to real-world social persuasion). Modified Tabula Rasa (Taiwan concept): under value debate, pure Tabula Rasa is logically impossible -- value content can only be "corroboration" not "demonstration." Appropriate restrictions on intervention, but respect the Tabula Rasa principle.
...
| 5 | Argument completeness: each logical link requires independent evidence; one piece of evidence cannot cover multiple argumentation steps | O1-O4 |
...
### A3 criterion B0 + Sub-Argument Construction
...
**This step does two things: establish the criterion B0, then Sub-Arguments support B0.**
...
Give 2-3 directions, recommend the one most likely to point toward your side and that you yourself genuinely believe. Follow up: "How did your Scope of Discussion (A2) influence which standard you could choose? If you switched entry directions, would your standard change?" Then ask: "You chose this criterion B0 — what do you believe in, or what do you feel is important, behind it? Not whether B0 itself is correct — what underlying reason makes this criterion B0 deserve to be the most important criterion for judging this question?" After the user responds, this is the value starting point that A4 will deepen.
...
Follow up one (Sub-Argument completeness): "Can each Sub-Argument independently tie back the criterion B0? Are there missed aspects -- will the opponent say 'you only talked about X, not Y'?"
...
(Note: True/False is only a distinction, not a quality judgment. Positional Interest is not useless — but stacking reinforcement layers on Positional Interest will cause the architecture to drift and produce hollow value appeals. Judges evaluate Intrinsic Value by propulsion force; Positional Interest by benefit argumentation.)" (Supplement — cause/effect self-check: Regardless of whether the user chose A or B, the coach must internally ask at each quadrant demonstration: "Is the direction I am now offering tracing the driving force behind this value (cause-direction), or merely listing benefits that come after accepting it (effect-direction)?" If the latter — step back and rethink. The four quadrants only admit cause-direction tracing.)
...
Wait for the user to respond. The coach must **demonstrate with a concrete example anchored to the user's specific value** — show what "go opposite" actually looks like for this value. What the reverse excavation finds is NOT "what consequences this value produces," but rather **what forces drive people to accept this value** — the value is the driven outcome, not the starting point. E.g. the user says "my value is generally affirmed, leans moral" → coach demonstrates: "Okay. Everyone affirms fairness — but why do people believe in fairness? Not because fairness is 'good,' but because the cost of injustice is too bloody for anyone to bear. Throughout human history, every system of fairness was born because injustice accumulated to a breaking point — violence, uprising, bloodshed threatened the order itself. Fairness is not a noble moral ideal — it is passive acceptance of a brutal equilibrium." After demonstrating, ask: "Does this direction resonate with you? Can you try another direction?"
...
**All four quadrants answer the same question: what forces drive people to accept this value? Not what consequences result from accepting it. The value is the driven outcome, not the starting point.** (The two axes of the four quadrants are "Affirm ↔ Negate" × "Value/Moral ↔ Real-world/Utilitarian." When tracing driving forces within each quadrant, the direction is to pursue upward — "what inner motivation makes people accept this value" — not to list downward — "what benefits come from accepting it." This is Internal Persuasion — focusing on core needs, rather than External Persuasion and surface professionalism.)

- **Quadrant 1 (Affirm x Value / Moral)**: Follow the public affirmation of the moral direction — find the moral-ethical foundation behind it. The public thinks this value is "right" — but what moral convictions make people feel it is right? What fundamental human moral needs is it responding to?
- **Quadrant 2 (Affirm x Utilitarian / Realistic)**: Find the positive self-interest calculation driving acceptance. For example, for "fairness," Q2 might be: "The point isn't fairness itself — fairness is the inevitable pursuit after maximizing collective benefit. Collective benefit comes first, and fairness follows as a necessity — not the other way around."
- **Quadrant 3 (Negate x Value / Moral)**: Find the negative value impulses driving acceptance — unavoidable greed, unbearable fear, inevitable arrogance. These negative value impulses, for certain reasons, inevitably push people toward this value.
- **Quadrant 4 (Negate x Utilitarian / Realistic)**: Find the negative real-world calculation driving acceptance. For example, injustice leads to social upheaval — the oppressed rise up. Behind fairness lies the equilibrium of blood and fire, not noble, but rock-solid.

After all four quadrants are exhaustively explored, the coach helps the user label the incongruity intensity of each quadrant — how many dimensions were reversed (0/1/2)? Diagonal quadrant (both dimensions reversed) = strongest颠覆性 (disruption); adjacent quadrant (one dimension reversed) = moderate shift of angle; same-quadrant deepening (zero dimensions reversed) = safest but may be cliché. The user selects the direction that resonates most as the primary value. Follow up: "Is there a reverse direction you're unconsciously ignoring? What seems like pure moral conviction may be driven by real-world interests behind it; what seems like cold calculation may be driven by deeper moral beliefs."
...
Round 3 (Value layer): "Is your B really that important? Could the opponent say a more important reason is actually something else? If a more important B-prime emerges, do you plan to argue that your own Bindeed is more important, or concede the opponent B, introducing a higher-level B-prime to cover it? (This is Absorption.)" Same as above.
...
"Do not only think about how to dismantle the opponent points. In the opponent argumentation, what are the reasonable parts (alpha->beta) -- the points you truly cannot deny. After conceding them, what then?"
...
**Step 3 (Where does B-prime come from?)**: "Your B-prime is not out of thin air imagined -- return to the Value Ladder from the value step; pursue upward along the ladder to find a higher-level value, or pursue downward to find a more specific benefit. B-prime is typically hidden in the upper level or reverse direction of the Value Ladder."
...
**Step 4 (Structural Clash Verification — formerly "Concession-Counter")**: "Worst case -- you concede all of the opponent's reasonable points, then what? Does your architecture still hold? This is Structural Clash -- you are using the architecture constructed during the preparation phase of 'the opponent is completely right, and our side still holds' to respond. Has your response accidentally broken through the Layer 1 common-sense boundary -- becoming Definitional Overreach? (First check direction: is this response reducing your own burden or increasing difficulty? A response that disadvantages you cannot be Definitional Overreach.) Note: Reversal, if improperly operated, is the path to slide into Definitional Overreach. Would a neutral audience member feel your response is 'reasonable reinterpretation' or 'you are cheating'?"

**Step 5 (B' Quality Check)**: "Look back — at the B' you constructed through the previous four steps. As Jing Ling says: the refined core logic itself is a Concession-Counter that serves as Standard reasonableness (i.e., the Value Point). B' is naturally three facets of one thing. Three checks: (1) **Clash-Construction Unity** — does B' simultaneously respond to the opponent's α→β and reinforce your C as a single move? (2) **Full Coverage** — using this one logic of B', can you go through every counter-example exhausted in A5? Is there any counter-example that B' cannot cover, requiring a separate path? (3) **Same Source as Your Value** — are B' and the value driving force deepened in A4 the same thing? All three pass → B' is naturally both Standard reasonableness and Structural Clash. Any one fails → go back to Step 3, continue searching up the Value Ladder until you find the B' that naturally passes all three."
...
**The Mainline essence is also an argument.** The criterion B0 you established in A3 is the micro-B (case-building level); what you face in A7 is the macro-B = {B1, B-prime-1, ..., Bn, B-prime-n} (full-match level). The same A->B->C logic, two scales (Pro Lecture 4, Four-in-One).
...
**Concede/Deny Diagnosis**: "Can your architecture concede the opponent's reasonable points? If it can accommodate → Type 1 has space. If it completely cannot → at most Type 2. Is the Structural Clash you did in A6 sufficient to support Type 1?"
...
**Mainline Clash Preparation — Five Parts** (check each): (1) The clash chain itself B — the logic chain direction formed by both sides' clashes; (2) AC — the Mainline impact of the motion / definition / Scope of Discussion; (3) First Arrow Factual Layer — can A→B withstand on-stage scrutiny; (4) Second Arrow Logical Layer — is the B→C argumentation chain solid; (5) Second Arrow Value Layer — does the value support run through the entire match.

**Closure Check**: "Finally, look back — is your ultimate stance 'A. Our side is completely right, the opponent is completely wrong' or 'B. Our side has points that hold, the opponent also has points that hold, but on the whole it is still our side'? (B is the True Stance. If the answer is A — go back to the Structural Clash step. Has your Structural Clash left accommodation space for the opponent's reasonable points?)"
...
"Next, five steps: Defense Self-Check -> Opponent Prediction -> Collision Defense -> Proactive Offense -> Decisive Projection. At any point, you can say 'skip this step' or 'Q&A' to switch to Open Q&A."
...
"Briefly tell me your architecture -- motion, stance, Scope of Discussion direction, criterion B0, Sub-Arguments. No need for detail; I just want to understand the overall framework."
...
| 3. criterion B0 | "criterion B0 -- [restate the user Standard]. Does it high probability point toward your side? Can each Sub-Argument independently tie back? Are there missed aspects? I see [risks / confirmations]. Do you agree?" | 4.1 |
| 4. Value | "Value layer -- is what you are pushing Intrinsic Value or Positional Interest? Have all four quadrants of the Perspective Entry been explored? Is there a reverse direction you are unconsciously ignoring? I tend toward [analysis]. What do you think? (If it's Positional Interest — note that Structural Clash is very difficult to sustain on Positional Interest. Positional Interest competes on benefit argumentation, not propulsion. Would you like to go back to the value step and trace forward to find the genuine driver behind criterion B0 that makes it an important reason?)" | 6.1 + 1.5 |
...
**Traditional Debate**: Predict the opponent A1-A4 level architecture (Definition -> Scope of Discussion -> criterion B0 -> Value direction). 1-2 most likely plans.
...
| 4. Structural Clash | "What are the reasonable parts of the opponent case (alpha->beta)? Do you plan Absorption or Reversal? For each point that stands, does the equation hold? Is there risk of Reversal sliding into Definitional Overreach? I recommend [direction] because [reason]. What do you think?" (5.3) |
...
criterion B0 layer: What B0 did each side choose — through this B0, whose importance was raised and whose lowered?
...
Step 1 — Locate each value's public-perception coordinates on the two axes: Attitude axis (is this value generally affirmed or negated by the public?) and Understanding axis (does general perception lean Moral/Value-based or Real-world/Utilitarian?). The two axes intersect: Affirm ↔ Negate × Value/Moral ↔ Real-world/Utilitarian.

Step 2 — Determine whether the value itself is "cause-direction traced" or "effect-direction listed": cause-direction = what is the debater's genuine motivation for choosing this value? (driving force before B0, corresponding to Internal Persuasion — focusing on core needs); effect-direction = is the debater merely listing the benefits of taking this stance? (position reinforcement after B0, corresponding to External Persuasion — surface benefit calculation).

For cause-direction Intrinsic Values: analyze which of the four quadrants this driving force falls into — on the Affirm/Negate and Moral/Real-world dimensions, what direction does the debater's value trace? How much incongruity (0/1/2 dimension Reversals) and "unfamiliarity" tension does this direction generate?
For effect-direction Positional Interests: label as "Positional Interest (effect-direction · position reinforcement)," then ask — if we go back before B0, what was the genuine driving force that made this debater choose this stance? After finding it, perform the four-quadrant positioning.

Compare both sides: whose driving-force tracing is more "cause-direction" (reaching core needs rather than surface benefits)? Whose cause-direction tracing reversed more familiarity dimensions (generating greater unfamiliarty and persuasion power)?
...
**C8. Three-Dimensional Model Review.** Use "Proof Side" (logical self-consistency / clash completion), "Persuasion Side" (audience identification / value resonance), and "Third-Party Side" (operational fluency / rule utilization) to assess each side's strengths and weaknesses. Include 1-2 specific examples per side illustrating typical performance on that side. On which end of each of the three dimensions does the judge lean (Persuasion axis: Guardian / Seeker? Proof axis: Critic / Judge? Third-Party axis: Technician / Artist?) — what is the overall tendency? Did the approach's strengths align with the judge's preference inclinations?

**C9. Alternative Developments.** Would switching the entry direction of the Scope of Discussion be better? Does the architecture leave room for Structural Clash? Where does the content fall on the Lv0-Lv6 interval? (When outputting, must include the full level name and a one-sentence explanation, e.g. "Lv3 Deepening of known answers — substantively advanced within the existing cognitive framework but did not restructure the answer framework.") If the stances were swapped, could both architectures still hold?
...
**C11. Overall Assessment.** Use a continuous narrative paragraph to conclude the post-mortem: what level this match reached under your chosen criterion; the outcome logic under your criterion (and if different from the actual result, explain why — different criterion or different adjudication under the same criterion); the match's cognitive contribution to the motion itself (content level Lv0-Lv6, including the full level name); its place in debate history / training value. Not a checklist — a final characterization and positioning of this match.
...
criterion B0 Layer: What B0 did each side choose — through this B0, what importance is elevated, and what is diminished?
